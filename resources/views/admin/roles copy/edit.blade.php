    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex p-2">
                    <a href="{{ route('admin.roles.index') }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">Volver a Roles</a>
                </div>
                ...
                <div class="mt-6 p-2 bg-slate-100">
                    <h2 class="font-semibold text-2xl">Permisos del rol:</h2>
                    <div class="flex space-x-2 mt-4 p-2">
                        @if ($role->permissions)
                            ...
                            <form class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md" 
                                ...
                                onsubmit="return confirm('¿Estás seguro de revocar este permiso del rol?');">
                                @csrf
                                @method('DELETE')
